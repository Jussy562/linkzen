...
function Navbar() {
    ...
    // console.log(open);
  return (
    <div className='navBar w-full py-4 md:py-8   z-50  sticky'>
        <nav className="navBar border-gray-200 dark:bg-gray-900 ">
            <div className="max-w-screen-xl flex flex-row flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center text-black self-center text-2xl font-bold whitespace-nowrap ">
                ...
                {/* <div className="flex md:order-2">
                    ...
                    <button type="button" className="text-[#e0b0ff] bg-[#e0b0ff] hover:bg-[#d08ffb] focus:ring-4 focus:outline-none focus:ring-[#d08ffb] font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-[#e0b0ff] dark:hover:bg-[#d08ffb]  dark:focus:ring-[#d08ffb] ">Get started</button>
                ...
                <div className='items-center justify-between w-auto flex flex-row order-1' id="navbar-cta">
